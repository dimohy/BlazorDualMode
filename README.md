...
The [Blazor Webassembly Demo](https://dimohy.maum.in/BlazorDualMode) and [Blazor Server Demp](https://dimohy.maum.in/BlazorDualMode/?mode=server) site will show you the difference in behavior.
